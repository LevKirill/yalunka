...
function extend$1(i, e) {
    ...
    Object.keys(e)
        ...
        .forEach((s) => {
            typeof i[s] > "u"
                ? (i[s] = e[s])
                : isObject$1(e[s]) && isObject$1(i[s]) && Object.keys(e[s]).length > 0 && extend$1(i[s], e[s]);
        });
}
const ssrDocument = {
    body: {},
...
function getDocument() {
    ...
    return extend$1(i, ssrDocument), i;
}
const ssrWindow = {
...
function getWindow() {
    ...
    return extend$1(i, ssrWindow), i;
}
function classesToTokens(i) {
    return (
        i === void 0 && (i = ""),
        i
            .trim()
    ...
    return (
        t.WebKitCSSMatrix
            ...
            : ((r =
              ...
              (s = r.toString().split(","))),
        e === "x" &&
            (t.WebKitCSSMatrix ? (n = r.m41) : s.length === 16 ? (n = parseFloat(s[12])) : (n = parseFloat(s[4]))),
        e === "y" &&
            (t.WebKitCSSMatrix ? (n = r.m42) : s.length === 16 ? (n = parseFloat(s[13])) : (n = parseFloat(s[5]))),
        n || 0
    );
}
function isObject(i) {
    ...
    for (let t = 1; t < arguments.length; t += 1) {
        ...
        if (s != null && !isNode(s)) {
            ...
            for (let r = 0, o = n.length; r < o; r += 1) {
                ...
                d !== void 0 &&
                    d.enumerable &&
                    (isObject(i[a]) && isObject(s[a])
                        ? s[a].__swiper__
                            ? (i[a] = s[a])
                            : extend(i[a], s[a])
                        : !isObject(i[a]) && isObject(s[a])
                        ? ((i[a] = {}), s[a].__swiper__ ? (i[a] = s[a]) : extend(i[a], s[a]))
                        : (i[a] = s[a]));
            }
        }
    }
...
function setCSSProperty(i, e, t) {
    i.style.setProperty(e, t);
}
function animateCSSModeScroll(i) {
...
function elementChildren(i, e) {
    e === void 0 && (e = "");
    const t = getWindow(),
        s = [...i.children];
    return (
        t.HTMLSlotElement && i instanceof HTMLSlotElement && s.push(...i.assignedElements()),
        e ? s.filter((n) => n.matches(e)) : s
    );
}
function elementIsChildOfSlot(i, e) {
    const t = [e];
    for (; t.length > 0; ) {
        const s = t.shift();
        if (i === s) return !0;
...
function elementIsChildOf(i, e) {
    ...
    return (
        !s &&
            ...
            ((s = [...e.assignedElements()].includes(i)), s || (s = elementIsChildOfSlot(i, e))),
        s
    );
}
...
function elementStyle(i, e) {
    return getWindow().getComputedStyle(i, null).getPropertyValue(e);
}
...
function elementParents(i, e) {
    const t = [];
    let s = i.parentElement;
    for (; s; ) t.push(s), (s = s.parentElement);
    return t;
}
function elementOuterSize(i, e, t) {
    const s = getWindow();
    return (
...
function calcDevice(i) {
    ...
    return (
        ...
        l && !m && ((o.os = "android"), (o.android = !0)),
        (c || p || u) && ((o.os = "ios"), (o.ios = !0)),
        o
    );
}
function getDevice(i) {
    return i === void 0 && (i = {}), deviceCached || (deviceCached = calcDevice(i)), deviceCached;
}
let browser;
                ...
                ((r = new ResizeObserver((u) => {
                    o = n.requestAnimationFrame(() => {
                        ...
                        let f = p,
                            h = m;
                        u.forEach((S) => {
                            let { contentBoxSize: g, contentRect: v, target: w } = S;
                            (w && w !== e.el) ||
                                ((f = v ? v.width : (g[0] || g).inlineSize),
                                (h = v ? v.height : (g[0] || g).blockSize));
                        }),
                            (f !== p || h !== m) && a();
                    });
                })),
        ...
        d = () => {
            if (e.params.observer) {
                if (e.params.observeParents) {
                    const c = elementParents(e.hostEl);
...
function updateSize() {
    ...
    typeof i.params.width < "u" && i.params.width !== null ? (e = i.params.width) : (e = s.clientWidth),
        ...
        !((e === 0 && i.isHorizontal()) || (t === 0 && i.isVertical())) &&
            ((e =
                e -
                parseInt(elementStyle(s, "padding-left") || 0, 10) -
                parseInt(elementStyle(s, "padding-right") || 0, 10)),
            (t =
                t -
                parseInt(elementStyle(s, "padding-top") || 0, 10) -
                parseInt(elementStyle(s, "padding-bottom") || 0, 10)),
            Number.isNaN(e) && (e = 0),
            Number.isNaN(t) && (t = 0),
...
function updateSlides() {
    ...
    const t = i.params,
        ...
        c = elementChildren(n, `.${i.params.slideClass}, swiper-slide`),
    ...
    const A =
        ...
        t.breakpoints &&
        Object.keys(t.breakpoints).filter((T) => typeof t.breakpoints[T].slidesPerView < "u").length > 0;
    for (let T = 0; T < u; T += 1) {
        E = 0;
        let x;
        if ((c[T] && (x = c[T]), C && i.grid.updateSlide(T, x, c), !(c[T] && elementStyle(x, "display") === "none"))) {
            if (t.slidesPerView === "auto") {
                A && (c[T].style[i.getDirectionLabel("width")] = "");
                const M = getComputedStyle(x),
                    L = x.style.transform,
                    V = x.style.webkitTransform;
                if ((L && (x.style.transform = "none"), V && (x.style.webkitTransform = "none"), t.roundLengths))
                    E = i.isHorizontal() ? elementOuterSize(x, "width") : elementOuterSize(x, "height");
                else {
                    const G = e(M, "width"),
                        P = e(M, "padding-left"),
                        O = e(M, "padding-right"),
                    ...
                    if (B && B === "border-box") E = G + z + k;
                    else {
                        const { clientWidth: D, offsetWidth: _ } = x;
                        E = G + P + O + z + k + (_ - D);
                    }
                }
                L && (x.style.transform = L), V && (x.style.webkitTransform = V), t.roundLengths && (E = Math.floor(E));
            } else
                (E = (r - (t.slidesPerView - 1) * w) / t.slidesPerView),
                    t.roundLengths && (E = Math.floor(E)),
                    c[T] && (c[T].style[i.getDirectionLabel("width")] = `${E}px`);
            c[T] && (c[T].swiperSlideSize = E),
                ...
                t.centeredSlides
                    ? ((y = y + E / 2 + b / 2 + w),
                      ...
                      m.push(y))
                    : (t.roundLengths && (y = Math.floor(y)),
                      (I - Math.min(i.params.slidesPerGroupSkip, I)) % i.params.slidesPerGroup === 0 && p.push(y),
                      m.push(y),
                      (y = y + E + w)),
                (i.virtualSize += E + w),
                (b = E),
    ...
    if (
        ((i.virtualSize = Math.max(i.virtualSize, r) + S),
        o && a && (t.effect === "slide" || t.effect === "coverflow") && (s.style.width = `${i.virtualSize + w}px`),
        t.setWrapperSize && (s.style[i.getDirectionLabel("width")] = `${i.virtualSize + w}px`),
        C && i.grid.updateWrapperSize(E, p),
        !t.centeredSlides)
    ) {
        const T = [];
        for (let x = 0; x < p.length; x += 1) {
            let M = p[x];
            t.roundLengths && (M = Math.floor(M)), p[x] <= i.virtualSize - r && T.push(M);
        }
        (p = T), Math.floor(i.virtualSize - r) - Math.floor(p[p.length - 1]) > 1 && p.push(i.virtualSize - r);
    }
    if (d && t.loop) {
        const T = f[0] + w;
        if (t.slidesPerGroup > 1) {
            ...
            for (let L = 0; L < x; L += 1) p.push(p[p.length - 1] + M);
        }
        for (let x = 0; x < i.virtual.slidesBefore + i.virtual.slidesAfter; x += 1)
            t.slidesPerGroup === 1 && p.push(p[p.length - 1] + T), m.push(m[m.length - 1] + T), (i.virtualSize += T);
    }
    if ((p.length === 0 && (p = [0]), w !== 0)) {
        const T = i.isHorizontal() && o ? "marginLeft" : i.getDirectionLabel("marginRight");
    ...
    if (
        (Object.assign(i, { slides: c, snapGrid: p, slidesGrid: m, slidesSizesGrid: f }),
        t.centeredSlides && t.cssMode && !t.centeredSlidesBounds)
    ) {
        setCSSProperty(s, "--swiper-centered-offset-before", `${-p[0]}px`),
            setCSSProperty(s, "--swiper-centered-offset-after", `${i.size / 2 - f[f.length - 1] / 2}px`);
        const T = -i.snapGrid[0],
            x = -i.slidesGrid[0];
        (i.snapGrid = i.snapGrid.map((M) => M + T)), (i.slidesGrid = i.slidesGrid.map((M) => M + x));
    }
    if (
        (u !== l && i.emit("slidesLengthChange"),
        p.length !== g && (i.params.watchOverflow && i.checkOverflow(), i.emit("snapGridLengthChange")),
        m.length !== v && i.emit("slidesGridLengthChange"),
        ...
        u <= t.maxBackfaceHiddenSlides ? x || i.el.classList.add(T) : x && i.el.classList.remove(T);
    }
}
function updateAutoHeight(i) {
    const e = this,
        t = [],
...
function updateSlidesProgress(i) {
    ...
    for (let d = 0; d < s.length; d += 1) {
        ...
        const u = (o + (t.centeredSlides ? e.minTranslate() : 0) - c) / (l.swiperSlideSize + a),
            p = (o - r[0] + (t.centeredSlides ? e.minTranslate() : 0) - c) / (l.swiperSlideSize + a),
            m = -(o - c),
            f = m + e.slidesSizesGrid[d],
            h = m >= 0 && m <= e.size - e.slidesSizesGrid[d],
            S = (m >= 0 && m < e.size - 1) || (f > 1 && f <= e.size) || (m <= 0 && f >= e.size);
        S && (e.visibleSlides.push(l), e.visibleSlidesIndexes.push(d)),
            toggleSlideClasses$1(l, S, t.slideVisibleClass),
...
const toggleSlideClasses = (i, e, t) => {
    e && !i.classList.contains(t) ? i.classList.add(t) : !e && i.classList.contains(t) && i.classList.remove(t);
};
function updateSlidesClasses() {
    const i = this,
        ...
        a = (u) => elementChildren(s, `.${t.slideClass}${u}, swiper-slide${u}`)[0];
    let d, l, c;
    if (r)
        if (t.loop) {
    ...
    d &&
        (o ||
            ((c = elementNextAll(d, `.${t.slideClass}, swiper-slide`)[0]),
            t.loop && !c && (c = e[0]),
            (l = elementPrevAll(d, `.${t.slideClass}, swiper-slide`)[0]),
            t.loop && !l === 0 && (l = e[e.length - 1]))),
        e.forEach((u) => {
            toggleSlideClasses(u, u === d, t.slideActiveClass),
                toggleSlideClasses(u, u === c, t.slideNextClass),
                toggleSlideClasses(u, u === l, t.slidePrevClass);
        }),
        i.emitSlidesClasses();
}
const processLazyPreloader = (i, e) => {
            ...
            !n &&
                ...
                (s.shadowRoot
                    ...
                    : requestAnimationFrame(() => {
                          s.shadowRoot &&
                              ((n = s.shadowRoot.querySelector(`.${i.params.lazyPreloaderClass}`)), n && n.remove());
                      })),
                n && n.remove();
        }
    },
    ...
    preload = (i) => {
        ...
        if (i.params.grid && i.params.grid.rows > 1) {
            ...
            a.push(...Array.from({ length: e }).map((d, l) => o + s + l)),
                i.slides.forEach((d, l) => {
                    a.includes(d.column) && unlazy(i, l);
                });
            return;
        }
        const r = n + s - 1;
        if (i.params.rewind || i.params.loop)
            ...
            for (let o = Math.max(n - e, 0); o <= Math.min(r + e, t - 1); o += 1)
                o !== n && (o > r || o < n) && unlazy(i, o);
    };
function getActiveIndexByTranslate(i) {
...
function updateActiveIndex(i) {
    ...
    if ((typeof d > "u" && (d = getActiveIndexByTranslate(e)), s.indexOf(t) >= 0)) l = s.indexOf(t);
    else {
    ...
    if (e.virtual && n.virtual.enabled && n.loop) p = c(d);
        ...
        Number.isNaN(f) && (f = Math.max(e.slides.indexOf(m), 0)), (p = Math.floor(f / n.grid.rows));
    } else if (e.slides[d]) {
    ...
    Object.assign(e, {
        ...
        e.initialized && preload(e),
        e.emit("activeIndexChange"),
        e.emit("snapIndexChange"),
        (e.initialized || e.params.runCallbacksOnInit) && (o !== p && e.emit("realIndexChange"), e.emit("slideChange"));
}
function updateClickedSlide(i, e) {
    const t = this,
        s = t.params;
...
function setTranslate(i, e) {
    ...
    t.isHorizontal() ? (a = s ? -i : i) : (d = i),
        ...
        n.cssMode
            ? (r[t.isHorizontal() ? "scrollLeft" : "scrollTop"] = t.isHorizontal() ? -a : -d)
            : n.virtualTranslate ||
              (t.isHorizontal() ? (a -= t.cssOverflowAdjustment()) : (d -= t.cssOverflowAdjustment()),
...
function translateTo(i, e, t, s, n) {
    i === void 0 && (i = 0),
    ...
    if ((s && i > d ? (c = d) : s && i < l ? (c = l) : (c = i), r.updateProgress(c), o.cssMode)) {
        ...
        if (e === 0) a[u ? "scrollLeft" : "scrollTop"] = -c;
            ...
            if (!r.support.smoothScroll)
                return animateCSSModeScroll({ swiper: r, targetPosition: -c, side: u ? "left" : "top" }), !0;
...
function transitionStart(i, e) {
    i === void 0 && (i = !0);
    const t = this,
        { params: s } = t;
    s.cssMode ||
        (s.autoHeight && t.updateAutoHeight(),
        transitionEmit({ swiper: t, runCallbacks: i, direction: e, step: "Start" }));
}
function transitionEnd(i, e) {
    i === void 0 && (i = !0);
    const t = this,
        { params: s } = t;
    (t.animating = !1),
        !s.cssMode && (t.setTransition(0), transitionEmit({ swiper: t, runCallbacks: i, direction: e, step: "End" }));
}
var transition = { setTransition, transitionStart, transitionEnd };
function slideTo(i, e, t, s, n) {
    ...
    if ((!f && !s && !n) || r.destroyed || (r.animating && a.preventInteractionOnTransition)) return !1;
    typeof e > "u" && (e = r.params.speed);
    const h = Math.min(r.params.slidesPerGroupSkip, o);
    let S = h + Math.floor((o - h) / r.params.slidesPerGroup);
    S >= d.length && (S = d.length - 1);
    const g = -d[S];
    if (a.normalizeSlideIndex)
        for (let C = 0; C < l.length; C += 1) {
            const E = -Math.floor(g * 100),
                A = Math.floor(l[C] * 100),
                T = Math.floor(l[C + 1] * 100);
            typeof l[C + 1] < "u"
                ? E >= A && E < T - (T - A) / 2
                    ? (o = C)
                    : E >= A && E < T && (o = C + 1)
    ...
    if (
        ...
        ((!r.allowSlideNext &&
            ...
            (!r.allowSlidePrev && g > r.translate && g > r.maxTranslate() && (u || 0) !== o))
    )
        return !1;
    ...
    if (!(w && n) && ((p && -g === r.translate) || (!p && g === r.translate)))
        return (
            ...
            a.effect !== "slide" && r.setTranslate(g),
    ...
    if (a.cssMode) {
        ...
        if (e === 0)
            ...
            if (!r.support.smoothScroll)
                return animateCSSModeScroll({ swiper: r, targetPosition: E, side: C ? "left" : "top" }), !0;
            m.scrollTo({ [C ? "left" : "top"]: E, behavior: "smooth" });
        }
        return !0;
    }
    const I = getBrowser().isSafari;
    return (
        w && !n && I && r.isElement && r.virtual.update(!1, !1, o),
        r.setTransition(e),
        r.setTranslate(g),
        r.updateActiveIndex(o),
        r.updateSlidesClasses(),
    ...
    if (n.params.loop)
        if (n.virtual && n.params.virtual.enabled) o = o + n.virtual.slidesBefore;
            ...
            c === "auto"
                ...
                : ((c = Math.ceil(parseFloat(n.params.slidesPerView, 10))), l && c % 2 === 0 && (c = c + 1));
            let u = d - a < c;
            if (
                (l && (u = u || a < Math.ceil(c / 2)), s && l && n.params.slidesPerView !== "auto" && !r && (u = !1), u)
            ) {
                const p = l
                    ? a < n.activeIndex
                        ? "prev"
...
function slidePrev(i, e, t) {
    ...
    let S = r[f.indexOf(m) - 1];
    if (typeof S > "u" && (n.cssMode || h)) {
        let v;
        r.forEach((w, y) => {
            m >= w && (v = y);
        }),
            typeof v < "u" && (S = h ? r[v] : r[v > 0 ? v - 1 : v]);
    }
    let g = 0;
    if (
        (typeof S < "u" &&
    ...
    if (e.loop) {
        ...
        (r = parseInt(i.clickedSlide.getAttribute("data-swiper-slide-index"), 10)),
            e.centeredSlides
                ...
                ? (i.loopFix(),
                  (n = i.getSlideIndex(elementChildren(t, `${o}[data-swiper-slide-index="${r}"]`)[0])),
                  nextTick(() => {
                      i.slideTo(n);
                  }))
                : i.slideTo(n);
...
function loopCreate(i, e) {
    const t = this,
        { params: s, slidesEl: n } = t;
    if (!s.loop || (t.virtual && t.params.virtual.enabled)) return;
    const r = () => {
            elementChildren(n, `.${s.slideClass}, swiper-slide`).forEach((m, f) => {
    ...
    const d = s.slidesPerGroup * (a ? s.grid.rows : 1),
        ...
        u = (p) => {
            for (let m = 0; m < p; m += 1) {
                const f = t.isElement
                    ? createElement("swiper-slide", [s.slideBlankClass])
                    : createElement("div", [s.slideClass, s.slideBlankClass]);
                t.slidesEl.append(f);
            }
        };
    if (l) {
...
function loopFix(i) {
    ...
    const { slides: c, allowSlidePrev: u, allowSlideNext: p, slidesEl: m, params: f } = l,
        { centeredSlides: h, initialSlide: S } = f;
    ...
    g === "auto"
        ...
        : ((g = Math.ceil(parseFloat(f.slidesPerView, 10))), h && g % 2 === 0 && (g = g + 1));
    ...
    const b = [],
        I = [],
        C = y ? Math.ceil(c.length / f.grid.rows) : c.length,
        E = o && C - S < g && !h;
    let A = E ? S : l.activeIndex;
    typeof r > "u" ? (r = l.getSlideIndex(c.find((P) => P.classList.contains(f.slideActiveClass)))) : (A = r);
    const T = s === "next" || !s,
        x = s === "prev" || !s;
    let M = 0,
        L = 0;
    const G = (y ? c[r].column : r) + (h && typeof n > "u" ? -g / 2 + 0.5 : 0);
    if (G < w) {
        M = Math.max(w - G, v);
        for (let P = 0; P < w - G; P += 1) {
            const O = P - Math.floor(P / C) * C;
            if (y) {
                const z = C - O - 1;
                for (let k = c.length - 1; k >= 0; k -= 1) c[k].column === z && b.push(k);
            } else b.push(C - O - 1);
        }
    } else if (G + g > C - w) {
        (L = Math.max(G - (C - w * 2), v)), E && (L = Math.max(L, g - C + S + 1));
        for (let P = 0; P < L; P += 1) {
            const O = P - Math.floor(P / C) * C;
            y
                ? c.forEach((z, k) => {
    ...
    if (
        ...
        l.params.effect === "cards" &&
            c.length < g + w * 2 &&
            (I.includes(r) && I.splice(I.indexOf(r), 1), b.includes(r) && b.splice(b.indexOf(r), 1)),
        x &&
            b.forEach((P) => {
                (c[P].swiperLoopMoveDOM = !0), m.prepend(c[P]), (c[P].swiperLoopMoveDOM = !1);
            }),
        T &&
            I.forEach((P) => {
                (c[P].swiperLoopMoveDOM = !0), m.append(c[P]), (c[P].swiperLoopMoveDOM = !1);
            }),
        l.recalcSlides(),
        f.slidesPerView === "auto"
            ? l.updateSlides()
            : y &&
              ((b.length > 0 && x) || (I.length > 0 && T)) &&
              l.slides.forEach((P, O) => {
                  l.grid.updateSlide(O, P, l.slides);
              }),
        ...
        if (b.length > 0 && x) {
            if (typeof e > "u") {
                const P = l.slidesGrid[A],
                    z = l.slidesGrid[A + M] - P;
                d
                    ? l.setTranslate(l.translate - z)
                    : (l.slideTo(A + Math.ceil(M), 0, !1, !0),
                      n &&
                          ((l.touchEventsData.startTranslate = l.touchEventsData.startTranslate - z),
            ...
            if (typeof e > "u") {
                ...
                const P = y ? I.length / f.grid.rows : I.length;
                l.slideTo(l.activeIndex - P, 0, !1, !0);
            }
    }
    if (((l.allowSlidePrev = u), (l.allowSlideNext = p), l.controller && l.controller.control && !a)) {
        const P = { slideRealIndex: e, direction: s, setTranslate: n, activeSlideIndex: r, byController: !0 };
        Array.isArray(l.controller.control)
            ? l.controller.control.forEach((O) => {
                  !O.destroyed &&
                      O.params.loop &&
                      O.loopFix({ ...P, slideTo: O.params.slidesPerView === f.slidesPerView ? t : !1 });
              })
...
function preventEdgeSwipe(i, e, t) {
    const s = getWindow(),
        { params: n } = i,
...
function onTouchStart(i) {
    ...
    let d = s.target;
    if (
        (r.touchEventsTarget === "wrapper" && !elementIsChildOf(d, e.wrapperEl)) ||
    ...
    if (r.noSwiping && (p ? closestElement(u, d) : d.closest(u))) {
        e.allowClick = !0;
        return;
    }
    ...
    const m = o.currentX,
        f = o.currentY;
    if (!preventEdgeSwipe(e, s, m)) return;
    ...
    let h = !0;
    d.matches(n.focusableElements) && ((h = !1), d.nodeName === "SELECT" && (n.isTouched = !1)),
        t.activeElement &&
            t.activeElement.matches(n.focusableElements) &&
            t.activeElement !== d &&
            (s.pointerType === "mouse" || (s.pointerType !== "mouse" && !d.matches(n.focusableElements))) &&
            t.activeElement.blur();
    const S = h && e.allowTouchMove && r.touchStartPreventDefault;
    (r.touchStartForcePreventDefault || S) && !d.isContentEditable && s.preventDefault(),
        r.freeMode && r.freeMode.enabled && e.freeMode && e.animating && !r.cssMode && e.freeMode.onTouchStart(),
        e.emit("touchStart", s);
}
function onTouchMove(i) {
    const e = getDocument(),
        t = this,
        s = t.touchEventsData,
    ...
    if (
        ...
        d.type === "pointermove" && (s.touchId !== null || d.pointerId !== s.pointerId))
    )
        return;
    let l;
    if (d.type === "touchmove") {
        if (((l = [...d.changedTouches].find((b) => b.identifier === s.touchId)), !l || l.identifier !== s.touchId))
            return;
    } else l = d;
    if (!s.isTouched) {
    ...
    if (!t.allowTouchMove) {
        d.target.matches(s.focusableElements) || (t.allowClick = !1),
            s.isTouched &&
                (Object.assign(r, { startX: c, startY: u, currentX: c, currentY: u }), (s.touchStartTime = now()));
        return;
    }
    if (n.touchReleaseOnEdges && !n.loop)
        if (t.isVertical()) {
            ...
            if (
                !o &&
                ((c < r.startX && t.translate <= t.maxTranslate()) || (c > r.startX && t.translate >= t.minTranslate()))
            )
                return;
        }
    if (
        ...
        e.activeElement && d.target === e.activeElement && d.target.matches(s.focusableElements))
    ) {
    ...
    if (typeof s.isScrolling > "u") {
        ...
        (t.isHorizontal() && r.currentY === r.startY) || (t.isVertical() && r.currentX === r.startX)
            ? (s.isScrolling = !1)
            : p * p + m * m >= 25 &&
              ((b = (Math.atan2(Math.abs(m), Math.abs(p)) * 180) / Math.PI),
              (s.isScrolling = t.isHorizontal() ? b > n.touchAngle : 90 - b > n.touchAngle));
    }
    if (
        (s.isScrolling && t.emit("touchMoveOpposite", d),
        typeof s.startMoving > "u" && (r.currentX !== r.startX || r.currentY !== r.startY) && (s.startMoving = !0),
        s.isScrolling || (d.type === "touchmove" && s.preventTouchMoveFromPointerMove))
    ) {
        s.isTouched = !1;
        return;
    }
    ...
    n.oneWayMovement && ((f = Math.abs(f) * (o ? 1 : -1)), (h = Math.abs(h) * (o ? 1 : -1))),
        (r.diff = f),
        (f *= n.touchRatio),
        o && ((f = -f), (h = -h));
    const S = t.touchesDirection;
    (t.swipeDirection = f > 0 ? "prev" : "next"), (t.touchesDirection = h > 0 ? "prev" : "next");
    const g = t.params.loop && !n.cssMode,
        v = (t.touchesDirection === "next" && t.allowSlideNext) || (t.touchesDirection === "prev" && t.allowSlidePrev);
    if (!s.isMoved) {
        if (
            (g && v && t.loopFix({ direction: t.swipeDirection }),
    ...
    if (
        ...
        n._loopSwapReset !== !1 &&
            ...
            S !== t.touchesDirection &&
            g &&
            v &&
            Math.abs(f) >= 1)
    ) {
        Object.assign(r, { startX: c, startY: u, currentX: c, currentY: u, startTranslate: s.currentTranslate }),
            (s.loopSwapReset = !0),
            (s.startTranslate = s.currentTranslate);
        return;
    }
    t.emit("sliderMove", d), (s.isMoved = !0), (s.currentTranslate = f + s.startTranslate);
    let w = !0,
        y = n.resistanceRatio;
    if (
        ...
        f > 0
            ? (g &&
                  ...
                  s.currentTranslate >
                      (n.centeredSlides
                          ? t.minTranslate() -
                            ...
                            (n.slidesPerView !== "auto" && t.slides.length - n.slidesPerView >= 2
              ...
              s.currentTranslate > t.minTranslate() &&
                  ((w = !1),
                  n.resistance &&
                      (s.currentTranslate = t.minTranslate() - 1 + (-t.minTranslate() + s.startTranslate + f) ** y)))
            : f < 0 &&
              (g &&
                  v &&
                  s.allowThresholdMove &&
              ...
              s.currentTranslate < t.maxTranslate() &&
                  ((w = !1),
                  n.resistance &&
                      (s.currentTranslate = t.maxTranslate() + 1 - (t.maxTranslate() - s.startTranslate - f) ** y))),
    ...
    !n.followFinger ||
        n.cssMode ||
        (((n.freeMode && n.freeMode.enabled && t.freeMode) || n.watchSlidesProgress) &&
...
function onTouchEnd(i) {
    ...
    if (s.type === "touchend" || s.type === "touchcancel") {
        if (((n = [...s.changedTouches].find((b) => b.identifier === t.touchId)), !n || n.identifier !== t.touchId))
            return;
    } else {
    ...
    for (let b = 0; b < l.length; b += b < o.slidesPerGroupSkip ? 1 : o.slidesPerGroup) {
        ...
        typeof l[b + I] < "u"
            ? (f || (m >= l[b] && m < l[b + I])) && ((h = b), (S = l[b + I] - l[b]))
            : (f || m >= l[b]) && ((h = b), (S = l[l.length - 1] - l[l.length - 2]));
    }
    let g = null,
        v = null;
    o.rewind &&
        (e.isBeginning
            ? (v = o.virtual && o.virtual.enabled && e.virtual ? e.virtual.slides.length - 1 : e.slides.length - 1)
            : e.isEnd && (g = 0));
    const w = (m - l[h]) / S,
    ...
    if (p > o.longSwipesMs) {
        ...
        e.swipeDirection === "next" &&
            (w >= o.longSwipesRatio ? e.slideTo(o.rewind && e.isEnd ? g : h + y) : e.slideTo(h)),
            e.swipeDirection === "prev" &&
                (w > 1 - o.longSwipesRatio
                    ? e.slideTo(h + y)
                    : v !== null && w < 0 && Math.abs(w) > o.longSwipesRatio
                    ? e.slideTo(v)
                    : e.slideTo(h));
    } else {
        if (!o.shortSwipes) {
...
function onResize() {
    ...
    const a = o && e.loop;
    (e.slidesPerView === "auto" || e.slidesPerView > 1) && i.isEnd && !i.isBeginning && !i.params.centeredSlides && !a
...
function onLoad(i) {
    const e = this;
    processLazyPreloader(e, i.target),
...
const events = (i, e) => {
    ...
    !n ||
        ...
        s.updateOnWindowResize
            ...
            : i[l]("observerUpdate", onResize, !0),
        n[d]("load", i.onLoad, { capture: !0 }));
};
function attachEvents() {
    const i = this,
        { params: e } = i;
    (i.onTouchStart = onTouchStart.bind(i)),
        (i.onTouchMove = onTouchMove.bind(i)),
        (i.onTouchEnd = onTouchEnd.bind(i)),
        (i.onDocumentTouchStart = onDocumentTouchStart.bind(i)),
        e.cssMode && (i.onScroll = onScroll.bind(i)),
        (i.onClick = onClick.bind(i)),
        (i.onLoad = onLoad.bind(i)),
        events(i, "on");
}
...
const isGridEnabled = (i, e) => i.grid && e.grid && e.grid.rows > 1;
function setBreakpoint() {
    ...
    const u = (l in r ? r[l] : void 0) || i.originalParams,
        ...
        S = s.enabled;
    p && !m
        ? (n.classList.remove(`${s.containerModifierClass}grid`, `${s.containerModifierClass}grid-column`),
          i.emitContainerClasses())
        : !p &&
          m &&
          (n.classList.add(`${s.containerModifierClass}grid`),
          ((u.grid.fill && u.grid.fill === "column") || (!u.grid.fill && s.grid.fill === "column")) &&
        ...
        ["navigation", "pagination", "scrollbar"].forEach((I) => {
            ...
            const C = s[I] && s[I].enabled,
                E = u[I] && u[I].enabled;
            C && !E && i[I].disable(), !C && E && i[I].enable();
        });
    const g = u.direction && u.direction !== s.direction,
        v = s.loop && (u.slidesPerView !== s.slidesPerView || g),
        w = s.loop;
    g && t && i.changeDirection(), extend(i.params, u);
...
function moduleExtendParams(i, e) {
    return function (s) {
        s === void 0 && (s = {});
...
class Swiper {
    constructor() {
        ...
        a.modules.forEach((c) => {
            c({
                params: t,
                swiper: a,
                extendParams: moduleExtendParams(t, d),
                on: a.on.bind(a),
                once: a.once.bind(a),
                off: a.off.bind(a),
                emit: a.emit.bind(a),
        ...
        const l = extend({}, defaults, d);
        return (
            (a.params = extend({}, l, extendedDefaults, t)),
            (a.originalParams = extend({}, a.params)),
            (a.passedParams = extend({}, t)),
            a.params &&
                a.params.on &&
    ...
    getSlideIndex(e) {
        const { slidesEl: t, params: s } = this,
            n = elementChildren(t, `.${s.slideClass}, swiper-slide`),
            r = elementIndex(n[0]);
    ...
    slidesPerViewDynamic(e, t) {
        ...
        if (n.centeredSlides) {
            let u = r[l] ? Math.ceil(r[l].swiperSlideSize) : 0,
                p;
            for (let m = l + 1; m < r.length; m += 1)
                r[m] && !p && ((u += Math.ceil(r[m].swiperSlideSize)), (c += 1), u > d && (p = !0));
            for (let m = l - 1; m >= 0; m -= 1)
                r[m] && !p && ((u += r[m].swiperSlideSize), (c += 1), u > d && (p = !0));
        } else if (e === "current")
            for (let u = l + 1; u < r.length; u += 1) (t ? o[u] + a[u] - o[l] < d : o[u] - o[l] < d) && (c += 1);
    ...
    mount(e) {
        ...
        let o =
            s && s.shadowRoot && s.shadowRoot.querySelector
                ...
                : elementChildren(s, n())[0];
        return (
            !o &&
                t.params.createElements &&
                ((o = createElement("div", t.params.wrapperClass)),
                s.append(o),
                elementChildren(s, `.${t.params.slideClass}`).forEach((a) => {
                    o.append(a);
                })),
            Object.assign(t, {
                el: s,
                ...
                rtlTranslate:
                    ...
                    (s.dir.toLowerCase() === "rtl" || elementStyle(s, "direction") === "rtl"),
    ...
    destroy(e, t) {
        ...
        return (
            typeof s.params > "u" ||
                ...
                e !== !1 && (s.el && typeof s.el != "string" && (s.el.swiper = null), deleteProps(s)),
                (s.destroyed = !0)),
            null
        );
    }
    ...
    static use(e) {
        return Array.isArray(e)
            ? (e.forEach((t) => Swiper.installModule(t)), Swiper)
            : (Swiper.installModule(e), Swiper);
    }
}
Object.keys(prototypes).forEach((i) => {
    Object.keys(prototypes[i]).forEach((e) => {
        Swiper.prototype[e] = prototypes[i][e];
    });
}),
    Swiper.use([Resize, Observer]);
function createElementIfNotDefined(i, e, t, s) {
    return (
        i.params.createElements &&
            Object.keys(s).forEach((n) => {
                if (!t[n] && t.auto === !0) {
                    let r = elementChildren(i.el, `.${s[n]}`)[0];
                    r || ((r = createElement("div", s[n])), (r.className = s[n]), i.el.append(r)),
                        (t[n] = r),
                        (e[n] = r);
                }
            }),
...
function Navigation(i) {
    ...
    function r(f) {
        let h;
        return f && typeof f == "string" && e.isElement && ((h = e.el.querySelector(f) || e.hostEl.querySelector(f)), h)
            ? h
            : (f &&
    ...
    function o(f, h) {
        ...
        (f = makeElementsArray(f)),
            f.forEach((g) => {
                g &&
                    (g.classList[h ? "add" : "remove"](...S.disabledClass.split(" ")),
                    g.tagName === "BUTTON" && (g.disabled = h),
                    e.params.watchOverflow && e.enabled && g.classList[e.isLocked ? "add" : "remove"](S.lockClass));
            });
    }
    function a() {
        ...
        o(h, e.isBeginning && !e.params.rewind), o(f, e.isEnd && !e.params.rewind);
    }
    function d(f) {
        f.preventDefault(),
    ...
    function c() {
        ...
        let h = r(f.nextEl),
            S = r(f.prevEl);
        Object.assign(e.navigation, { nextEl: h, prevEl: S }), (h = makeElementsArray(h)), (S = makeElementsArray(S));
        const g = (v, w) => {
            v && v.addEventListener("click", w === "next" ? l : d),
                !e.enabled && v && v.classList.add(...f.lockClass.split(" "));
        };
        h.forEach((v) => g(v, "next")), S.forEach((v) => g(v, "prev"));
    }
    function u() {
        let { nextEl: f, prevEl: h } = e.navigation;
        (f = makeElementsArray(f)), (h = makeElementsArray(h));
        const S = (g, v) => {
            g.removeEventListener("click", v === "next" ? l : d),
                g.classList.remove(...e.params.navigation.disabledClass.split(" "));
        };
        f.forEach((g) => S(g, "next")), h.forEach((g) => S(g, "prev"));
    }
    s("init", () => {
        ...
        s("enable disable", () => {
            let { nextEl: f, prevEl: h } = e.navigation;
            if (((f = makeElementsArray(f)), (h = makeElementsArray(h)), e.enabled)) {
                a();
                return;
            }
            [...f, ...h].filter((S) => !!S).forEach((S) => S.classList.add(e.params.navigation.lockClass));
        }),
        s("click", (f, h) => {
            let { nextEl: S, prevEl: g } = e.navigation;
            (S = makeElementsArray(S)), (g = makeElementsArray(g));
            const v = h.target;
            let w = g.includes(v) || S.includes(v);
            if (e.isElement && !w) {
                const y = h.path || (h.composedPath && h.composedPath());
                y && (w = y.find((b) => S.includes(b) || g.includes(b)));
            }
            if (e.params.navigation.hideOnClick && !w) {
                ...
                S.length
                    ...
                    [...S, ...g].filter((b) => !!b).forEach((b) => b.classList.toggle(e.params.navigation.hiddenClass));
            }
        });
    const p = () => {
    ...
    Object.assign(e.navigation, { enable: p, disable: m, update: a, init: c, destroy: u });
}
function initSliders() {
    document.querySelector(".teaser__slider") &&
        new Swiper(".teaser__slider", {
            ...
            spaceBetween: 0,
            speed: 800,
            navigation: { prevEl: ".teaser-swiper-button-prev", nextEl: ".teaser-swiper-button-next" },
            breakpoints: {
        ...
        document.querySelector(".catalog__slider  ") &&
            new Swiper(".catalog__slider  ", {
                ...
                spaceBetween: 0,
                speed: 800,
                navigation: { prevEl: ".catalog-swiper-button-prev", nextEl: ".catalog-swiper-button-next" },
                breakpoints: {
                    640: { slidesPerView: 2, spaceBetween: 20, autoHeight: !0 },
        ...
        document.querySelector(".discount__slider") &&
            new Swiper(".discount__slider", {
                ...
                spaceBetween: 0,
                speed: 800,
                navigation: { prevEl: ".discount-swiper-button-prev", nextEl: ".discount-swiper-button-next" },
                breakpoints: {
                    320: { slidesPerView: 1, spaceBetween: 0, autoHeight: !0 },
                    768: { slidesPerView: 2, spaceBetween: 20 },
                    992: { slidesPerView: 3, spaceBetween: 20 },
        ...
        document.querySelector(".gal__slider") &&
            new Swiper(".gal__slider", {
                modules: [Navigation],
                observer: !0,
                observeParents: !0,
                slidesPerView: 1,
                spaceBetween: 0,
                speed: 800,
                navigation: { prevEl: ".gal-swiper-button-prev", nextEl: ".gal-swiper-button-next" },
                breakpoints: {
                    320: { slidesPerView: 1, spaceBetween: 0, autoHeight: !0 },
                    768: { slidesPerView: 2, spaceBetween: 20 },
                    992: { slidesPerView: 3, spaceBetween: 20 },
        ...
        document.querySelector(".partners__slider") &&
            new Swiper(".partners__slider", {
                ...
                spaceBetween: 0,
                speed: 800,
                navigation: { prevEl: ".partners-swiper-button-prev", nextEl: ".partners-swiper-button-next" },
                breakpoints: {
                    320: { slidesPerView: 2, spaceBetween: 30, autoHeight: !0 },
                    640: { slidesPerView: 3, spaceBetween: 20, autoHeight: !0 },
                    768: { slidesPerView: 4, spaceBetween: 20 },
                    992: { slidesPerView: 5, spaceBetween: 20 },
                    1268: { slidesPerView: 6, spaceBetween: 30 },
                },
                on: {},
            }),
        document.querySelector(".video__slider") &&
            new Swiper(".video__slider", {
                ...
                spaceBetween: 0,
                speed: 800,
                navigation: { prevEl: ".video-swiper-button-prev", nextEl: ".video-swiper-button-next" },
                breakpoints: {
                    320: { slidesPerView: 1, spaceBetween: 0, autoHeight: !0 },
                    768: { slidesPerView: 2, spaceBetween: 20 },
                    992: { slidesPerView: 3, spaceBetween: 20 },
                    1268: { slidesPerView: 4, spaceBetween: 100 },
                },
                on: {},
            });
}
...
let bodyLockStatus = !0,
    bodyLockToggle = (i = 500) => {
        document.documentElement.hasAttribute("data-fls-scrolllock") ? bodyUnlock(i) : bodyLock(i);
    },
    bodyUnlock = (i = 500) => {
        if (bodyLockStatus) {
            const e = document.querySelectorAll("[data-fls-lp]");
            setTimeout(() => {
                e.forEach((t) => {
...
function menuInit() {
    document.addEventListener("click", function (i) {
        bodyLockStatus &&
            i.target.closest("[data-fls-menu]") &&
            (bodyLockToggle(), document.documentElement.toggleAttribute("data-fls-menu-open"));
    });
}
